...
@section('content-wrapper') 
     ...
     <div class="card-body card-pd">
        <div class="table-responsive">
                ...
                @endif
                {!! Form::open(array('route' =>'admin.movie.store' , 'files' => true , 'method' =>'POST')) !!}
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                ...
                                <input type="file" name="url_picture" class="url_picture">
                                @error('url_picture')
                                    <small class="text-danger">{{ $message }}</small> 
                                @enderror
                            </div>
                            <div class="form-group col-6">
                                ...
                                <input type="file" name="url_link" class="url_picture" placeholder="{{trans('admin.enter')}} {{trans('admin.url_link')}}">
                                @error('url_link')
                                    <small class="text-danger">{{ $message }}</small> 
                                @enderror
                            </div>
